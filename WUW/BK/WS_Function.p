...
ELSE DO:
    ...
    OUTPUT TO "D:\WebOS\LOG_WSTEST_WCZGENRC0.txt" APPEND.
    ...
    FUNCTION WCZGENRC0 RETURNS CHARACTER
      (INPUT  json   AS LONGCHAR,
       OUTPUT jsonRS AS LONGCHAR)   IN hWCZGENRC0Obj.
    
    
    /* Function invocation of WCZGENRC0 operation. */
    result = WCZGENRC0(json, jsonRS).
